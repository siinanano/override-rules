...
(() => {
  ...
  // src/constants.ts
  var NODE_SUFFIX, CDN_URL, GIT_URL, PROXY_GROUPS, LOW_COST_NODE_MATCHER, LANDING_NODE_MATCHER, countriesMeta;
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `RULE-SET,Fantia,${PROXY_GROUPS.JAPANWEB}`,
        ...
        `RULE-SET,JapanWeb,${PROXY_GROUPS.JAPANWEB}`,
        `GEOSITE,pixiv,${PROXY_GROUPS.JAPANWEB}`,
        `GEOSITE,dlsite,${PROXY_GROUPS.JAPANWEB}`,
        `GEOSITE,niconico,${PROXY_GROUPS.JAPANWEB}`,
        ...
        `GEOSITE,bangumi,${PROXY_GROUPS.BANGUMI}`,
        `RULE-SET,Other,${PROXY_GROUPS.OTHER}`,
        ...
        `GEOSITE,steam,${PROXY_GROUPS.STEAM}`,
